...
@.str = private unnamed_addr constant [26 x i8] c"Multiplication res: %d; \0A\00", align 1
...
30:                                               ; preds = %8
  ...
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i64 0, i64 0), i32 %32)
  ret i32 0
}
